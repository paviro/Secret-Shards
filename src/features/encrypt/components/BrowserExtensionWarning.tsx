        ...
        >
            {(collapse) => (
                <div className="space-y-4">
                    ...
                    <p className="text-slate-300 leading-relaxed">
                        For the highest level of security, it is advisable to temporarily disable extensions or use this tool in an <strong>Incognito</strong> or <strong>Private</strong> window where extensions are typically disabled by default.
                    </p>
