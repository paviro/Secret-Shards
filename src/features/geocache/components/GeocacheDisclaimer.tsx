...
export default function GeocacheDisclaimer({ onStart }: GeocacheDisclaimerProps) {
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-6">
            <div className="bg-slate-900/80 backdrop-blur-xl border border-indigo-500/30 rounded-2xl max-w-md p-6 shadow-xl animate-in fade-in zoom-in-95 duration-300 w-full">
                ...
                <div className="bg-indigo-950/30 border border-indigo-500/30 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-indigo-200 text-sm mt-2">
                        The data remains on your device until you explicitly start a new session. For one-time secrets, please use the main page.
                    </p>
                </div>
